		...
		switch (bundle_type) 
		{
			...
			case "a":
				...
				else
				{
					...
					System.out.printf("Your total charges are $%.2f\n", total_charge);
					System.out.printf("You would have saved $%.2f if you had gotten package B\n", ( total_charge- rate_packB));
					System.out.printf("You would have saved $%.2f if you had gotten package c", (total_charge-rate_packC));
					break;
				}
			case "B":
			case "b":
